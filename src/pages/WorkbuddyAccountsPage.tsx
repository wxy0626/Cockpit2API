...
export function WorkbuddyApiGatewayPanel() {
 ...
 // 本地账号库统计：账号状态只反映 Cockpit2API 自己的账号，不与 wb2api 网关账号池挂钩
